...
src_install() {
	...
	fperms 755 ${DIR}/bin/{format.sh,inspect.sh,ltedit.sh,pycharm.sh,restart.py,remote-dev-server.sh,repair}

	fperms 755 ${DIR}/${JRE_DIR}/bin/{javadoc,jinfo,java,javac,jcmd,jdb,jfr,jhsdb,jinfo,jmap,jps,jrunscript,jstack,jstat,keytool,rmiregistry,serialver}
