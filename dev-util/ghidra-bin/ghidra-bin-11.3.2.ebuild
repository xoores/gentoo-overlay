...
src_install() {
	...
	fperms 0755 \
		...
		"${GHIDRA_DESTDIR}/support/jythonRun" \
		"${GHIDRA_DESTDIR}/support/jshellRun" \
		"${GHIDRA_DESTDIR}/support/pyghidraRun" \
		"${GHIDRA_DESTDIR}/support/sleigh" \
		"${GHIDRA_DESTDIR}/support/bsim" \
		"${GHIDRA_DESTDIR}/support/buildGhidraJar" \
		"${GHIDRA_DESTDIR}/support/convertStorage" \
		"${GHIDRA_DESTDIR}/support/gdbGADPServerRun" \
		"${GHIDRA_DESTDIR}/support/ghidraClean" \
		"${GHIDRA_DESTDIR}/support/ghidraDebug" \
		"${GHIDRA_DESTDIR}/support/gradle" \
		"${GHIDRA_DESTDIR}/GPL/DemanglerGnu/os/linux_x86_64/demangler_gnu_v2_24" \
		"${GHIDRA_DESTDIR}/GPL/DemanglerGnu/os/linux_x86_64/demangler_gnu_v2_41" \
		"${GHIDRA_DESTDIR}/Ghidra/Features/Decompiler/os/linux_x86_64/decompile" \
		"${GHIDRA_DESTDIR}/Ghidra/Features/Decompiler/os/linux_x86_64/sleigh" \
		"${GHIDRA_DESTDIR}/Ghidra/Features/FileFormats/os/linux_x86_64/lzfse"
